...
flags.DEFINE_integer('n_inducing_points', 0, 'Number of inducing points; does not use inducing points if 0.')
...
def load(config, **unused_kwargs):
    ...
    encoder = SetTransformer(config.input_dim, config.n_outputs, config.output_dim,
